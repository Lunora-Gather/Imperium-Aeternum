...
Object.assign(en, {
  ...
  '我的名片': 'My card',
  '遇见新的统治者': 'Meet other rulers',
  '点击头像查看名片，喜欢就直接发送好友申请。': 'Select an avatar to view a player card, then add them directly.',
  '换一批': 'Refresh',
  '发消息': 'Message',
  '等待你回应': 'Awaiting your response',
  '查看名片': 'View card',
  '正在寻找玩家…': 'Finding players…',
  '暂时没有更多玩家': 'No more players right now',
