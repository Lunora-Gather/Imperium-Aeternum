...
const en: Record<string, string> = {
  ...
  '第一章 · 稳住朝局': 'Chapter I · Secure the Court', '治理至少两年，并维持安定 40、法统 35。': 'Govern for at least two years while maintaining 40 stability and 35 legitimacy.',
  ...
  '第二章 · 万邦协和': 'Chapter II · Concord of Nations', '终章 · 留下国祚': 'Final Chapter · Secure the Legacy',
