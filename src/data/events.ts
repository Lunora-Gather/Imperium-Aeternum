...
export const EVENTS: EventDef[] = [
  ...
  { id: 'evt_pop_migration', title: '人口外流', description: '边省民众大规模向邻邦迁徙！', category: 'population', trigger: { minTurn: 12, maxStability: 50 }, weight: 4, cooldown: 35, unique: false, options: [{ text: '减税挽留', effects: { gold: -80, population: 100, factionSat: fr('commoners', 10) }, aiWeight: 3 }, { text: '强行禁止', effects: { stability: -8, legitimacy: -5, factionSat: fr('commoners', -15) }, aiWeight: 2 }] },
