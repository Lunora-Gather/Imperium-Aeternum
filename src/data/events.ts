...
export const EVENTS: EventDef[] = [
  ...
  // ── 外交类 ──
  {
    id: 'evt_border_clash', title: '边境外交危机', description: '与邻国边境发生小规模冲突。',
    category: 'diplomacy',
  ...
  { id: 'evt_refugee_wave', title: '边境难民潮', description: '邻国战乱，难民涌入边境！', category: 'crisis', trigger: { minTurn: 10 }, weight: 4, cooldown: 35, unique: false, options: [{ text: '接纳安置', effects: { population: 500, food: -50, stability: -3 }, aiWeight: 2 }, { text: '关闭边境', effects: { legitimacy: -5, factionSat: fr('commoners', 5) }, aiWeight: 3 }] },
  ...
  { id: 'evt_border_incident', title: '边军冲突', description: '边防军与邻国发生小规模冲突！', category: 'military', trigger: { minTurn: 5 }, weight: 5, cooldown: 20, unique: false, options: [{ text: '强硬回应', effects: { stability: 3, factionSat: fra({ faction: 'military', delta: 8 }, { faction: 'merchants', delta: -5 }) }, aiWeight: 2 }, { text: '外交斡旋', effects: { gold: -30, legitimacy: 3 }, aiWeight: 3 }] },
  ...
  { id: 'evt_mint_debasement', title: '劣币铸造之议', description: '国库吃紧，有人建议铸劣币！', category: 'economy', trigger: { minTurn: 10 }, weight: 4, cooldown: 30, unique: false, options: [{ text: '铸劣币', effects: { gold: 150, corruption: 8, legitimacy: -8 }, aiWeight: 2 }, { text: '维持信用', effects: { legitimacy: 5 }, aiWeight: 3 }] },
  ...
  { id: 'evt_culture_renaissance', title: '古典文艺复兴', description: '古典学术复兴，新思潮涌动！', category: 'culture', trigger: { minTurn: 30, techLevelAbove: { branch: 'admin', level: 3 } }, weight: 2, cooldown: 60, unique: true, options: [{ text: '大力倡导', effects: { gold: -150, sciPt: 40, stability: 5, factionSat: fra({ faction: 'merchants', delta: 20 }, { faction: 'clergy', delta: -8 }) }, aiWeight: 3 }, { text: '顺其自然', effects: { sciPt: 15 }, aiWeight: 2 }] },
  { id: 'evt_culture_ban', title: '异端学说', description: '新奇学说挑战传统，教会要求查禁！', category: 'culture', trigger: { minTurn: 20, techLevelAbove: { branch: 'admin', level: 2 } }, weight: 4, cooldown: 35, unique: false, options: [{ text: '查禁异端', effects: { stability: 3, sciPt: -10, factionSat: fra({ faction: 'clergy', delta: 12 }, { faction: 'merchants', delta: -15 }) }, aiWeight: 2 }, { text: '保护学术', effects: { stability: -4, sciPt: 15, factionSat: fr('clergy', -10) }, aiWeight: 3 }] },
  { id: 'evt_culture_festival', title: '诸邦朝贺', description: '诸邦遣使朝贺，国威远扬！', category: 'culture', trigger: { minTurn: 25, notAtWar: true, minStability: 60 }, weight: 3, cooldown: 50, unique: false, options: [{ text: '盛典礼之', effects: { gold: -120, legitimacy: 10, influence: 15 }, aiWeight: 3 }, { text: '简礼相待', effects: { legitimacy: 3, influence: 5 }, aiWeight: 2 }] },
  ...
  { id: 'evt_pop_labor_short', title: '战后劳力短缺', description: '战乱后田地荒芜，劳力匮乏！', category: 'population', trigger: { minTurn: 15, atWar: true }, weight: 4, cooldown: 30, unique: false, options: [{ text: '招募流民', effects: { gold: -50, population: 80, food: 20 }, aiWeight: 3 }, { text: '强制征发', effects: { population: 50, stability: -5, factionSat: fr('commoners', -10) }, aiWeight: 1 }] },
  ...
  { id: 'evt_sci_translation', title: '译经运动', description: '异域典籍传入，请旨翻译！', category: 'science', trigger: { minTurn: 20, notAtWar: true }, weight: 3, cooldown: 40, unique: false, options: [{ text: '设译场', effects: { gold: -80, sciPt: 25, factionSat: fra({ faction: 'clergy', delta: 12 }, { faction: 'merchants', delta: 5 }) }, aiWeight: 3 }, { text: '民间自译', effects: { sciPt: 8 }, aiWeight: 2 }] },
  ...
  { id: 'evt_dip_refugee_crisis', title: '外交难民危机', description: '邻邦内乱，难民涌入！', category: 'diplomacy', trigger: { minTurn: 20 }, weight: 3, cooldown: 35, unique: false, options: [{ text: '设营安置', effects: { gold: -80, food: -40, population: 100, influence: 8 }, aiWeight: 3 }, { text: '封闭边境', effects: { influence: -8, stability: 2 }, aiWeight: 2 }] },
  ...
  { id: 'evt_culture_relic', title: '古寺圣物出土', description: '古寺出土圣物，信众蜂拥朝拜！', category: 'culture', trigger: { minTurn: 18, notAtWar: true }, weight: 3, cooldown: 50, unique: false, options: [{ text: '迎入京畿', effects: { gold: -60, legitimacy: 8, factionSat: fr('clergy', 15), influence: 5 }, aiWeight: 3 }, { text: '留寺供奉', effects: { stability: 3, factionSat: fr('clergy', 8) }, aiWeight: 2 }] },
  ...
  { id: 'evt_devaluation', title: '币值崩跌', description: '铸币掺假，币值暴跌！', category: 'economy', trigger: { minCorruption: 50 }, weight: 4, cooldown: 30, unique: false, options: [{ text: '整顿币制', effects: { gold: -100, legitimacy: 5, corruption: -5 }, aiWeight: 3 }, { text: '借机牟利', effects: { gold: 150, corruption: 8, factionSat: fr('merchants', -10) }, aiWeight: 2 }] },
  ...
  { id: 'evt_opp_relic', title: '传说圣物现世', description: '传说圣物被发掘！', category: 'opportunity', trigger: { minTurn: 20 }, weight: 2, cooldown: 60, unique: false, options: [{ text: '供奉展示', effects: { gold: -30, legitimacy: 10, factionSat: fr('clergy', 15), influence: 8 }, aiWeight: 3 }, { text: '秘藏', effects: { legitimacy: 3 }, aiWeight: 2 }] },
  ...
  { id: 'evt_d1_labor_short', title: '工程劳力短缺', description: '兴建大工程劳力不足。', category: 'economy', trigger: { minTurn: 12 }, weight: 3, cooldown: 25, unique: false, options: [{ text: '征役', effects: { factionSat: fr('commoners', -10), stability: -3 }, aiWeight: 2 }, { text: '募工', effects: { gold: -100 }, aiWeight: 3 }] },
  // military +10
