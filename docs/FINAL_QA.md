...
This checklist is the final verification path for the 1.1.1 stable patch.
...
1. Open the game.
2. Confirm the footer/build marker shows `1.1.1`.
...
Do not tag 1.1.1 if any of these are true:
